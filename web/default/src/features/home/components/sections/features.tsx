        ...
        <div className='mt-4 grid grid-cols-3 gap-2'>
          {['OpenAI', 'Claude', 'Gemini', 'DeepSeek', 'Qwen', 'Llama'].map(
            (name) => (
              <div
                key={name}
                className='border-border/30 bg-muted/20 text-muted-foreground flex items-center justify-center rounded-lg border px-3 py-2 text-xs transition-colors duration-300 hover:border-border hover:bg-muted/40'
              >
                {name}
              </div>
            )
      ...
      visual: (
        <div className='mt-4 flex items-center justify-center'>
          <div className='relative'>
            ...
            <div className='absolute -top-1 -right-1 flex size-4 items-center justify-center bg-foreground rounded-full'>
              <svg
              ...
              <div key={step} className='flex items-center gap-2'>
                <div
                  className={`flex size-6 items-center justify-center rounded-full text-[10px] font-bold ${
                    i === 1
                      ? 'border-foreground/30 bg-foreground/10 text-foreground border'
